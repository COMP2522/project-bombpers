...
public class EnemyConfig {
  ...
  /**
   * The number of enemy types.
   */
  public static final int ENEMY_TYPES = 3;

  /**
   * number for standard enemy.
   */
   ...
   */
  public static final String ENEMY_STANDARD_SPRITE = "../img/enemy_standard.png";

  /**
   * number for fast enemy.
   */
   ...
   * fast enemy sprite.
   */
  public static final String ENEMY_FAST_SPRITE = "../img/enemy_fast.png";

  /**
   * number for slow enemy.
   */
   ...
   * slow enemy sprite.
   */
  public static final String ENEMY_SLOW_SPRITE = "../img/enemy_slow.png";
}
